    	...
    	<div id="content">
			...
			<div id="content-main">
    			...
    			<table id="albumEdit">
    				<tbody><tr>
    					<td>唱片名称：</td>
    					<td><input class="txt" id="title" name="title" value="${album.title}" type="text">
    						</td>
    				</tr>
    				<tr>
    					<td>唱片封面：</td>
    					...
    					<input type="file" name="CoverImages" value="${album.id}"/>
    					</td>
    				</tr>
    				<tr>
    					<td>歌手：</td>
    					<td><input class="txt" id="artist" name="artist" value="${album.artist}" type="text">
    						</td>
    				</tr>
    				<tr>
    					<td>唱片分类：</td>
    				...
    				<tr>
    					<td>单价：</td>
    					<td><input class="txt" id="price" name="price" value="${album.price}" type="text">
    						</td>
    				</tr>
    				<tr>
    					<td>库存：</td>
    					<td><input class="txt" id="stock" name="stock" value="${album.stock}" type="text">
    						</td>
    				</tr>
    				<tr>
    					<td>发行日期：</td>
    					<td><input class="txt hasDatepicker" id="dateReleased" name="dateReleased" value="${ album.dateReleased}" type="text">
    						</td>
    				</tr>
    				<tr>
    					<td>唱片详细信息：</td>
    					<td><textarea id="description" name="description" style="width:400px; height:120px;">${album.description}</textarea>
    					</td>
    				</tr>
    				<tr>
    					<td></td>
